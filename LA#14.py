...
print(tobey_spdrMan.name.upper(), tobey.spdrMan.movieTitle)
print(andrew_spdrMan.name.upper(), tobey.spdrMan.movieTitle)
print(tom_spdrMan.name.upper(), tobey.spdrMan.movieTitle)
